...
@Override
    public String toString() {
     ...
     public void charge(int charge ){
      ...
      public boolean kilometersToDrive(double correctKilometersToDrive){
          
       correctKilometersToDrive=CurrentKilowatHoursInBattery-(correctKilometersToDrive/KilometersPerKilowattHour);
       if (correctKilometersToDrive< 0||                               
               System.out.println(""
